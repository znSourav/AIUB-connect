                    ...
                    $(document).ready(function(){
                      ...
                      headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                        ...
                        else if(res2[0].pic_flag==1)    
                        {
                          ...
                          $('#connect{{$countConnect}}').html('<div class="company_profile_info badge-fsit"><div class="company-up-info"><img  src="' + picSr + '" alt="Card image cap"><h3><a class="card-title"><a href="/profile/connectedView/' + res2[0].userId + '">' + res2[0].userName + '</a></h3><p>' + res2[0].userId + '<br>' + res2[0].program + '</p><a class="btn btn-primary  btn-block" href="/connect/disconnect-people/' + res2[0].userId + '" >Disconnect</a>');
                        }     
                      });
                    })    
                  </script>
