  ...
  <div class="wrapper">
   <header id="header" class="sticky-top">
    ...
    <section class="cover-sec">
      ...
      <a class="post_project" href="#" title=""><i class="fa fa-camera"></i> Change Image</a>
    </section>
      ...
      <div class="main-section">
                ...
                <div class="main-left-sidebar">
                  <div class="user_profile">
                    <div class="user-pro-img">
                      <img src="{{$pic}}" alt="" style="width: 180px; height: 180px;">
                      <a class="post-cam active" href="#" title=""><i class="fa fa-camera"></i></a>
              ...
              <div class="col-lg-6">
                <div class="main-ws-sec">
                  <div class="user-tab-sec">
                    ...
                    <div class="tab-feed st2">
                      <ul>
                        ...
                        <li data-tab="info-dd">
                          <a href="#" title="">
                            <img src="/vendor/images/ic2.png" alt="">
                            <span>Info</span>
                          </a>
                        </li>
                  ...
                  <div class="post-topbar">
                    <div class="user-picy">
                      <img src="{{$pic}}" alt="" style="border-radius: 50%;">
                    </div>
                    <div class="post-st">
                      <ul>
        ...
        <div class="post-bar">
          ...
          <div class="usy-dt">
            ...
            <div class="usy-name">
              <h3>
                <a href="{{route('user.profile',['id'=>session('user')])}}">{{$userInfo->userName}}</a>
              </h3>
            ...
            @endif
                  ...
                  <div class="product-feed-tab" id="info-dd">
                    <div class="user-profile-ov">
                      ...
                      <h3>Basic Info</h3>
                      <p> <em>Student ID :</em>{{$userInfo->userId}} </p>
                      <p> CGPA :  {{$userInfo->cgpa}} </p>
                      <p>Department :{{$userInfo->department}}</p>
                      <p>Program :  {{$userInfo->program}}</p>
                      <p>Email :  {{$userInfo->email}}</p>
                      <p>Gender : {{$userInfo->gender}}</p>
                      <p>Religion : {{$userInfo->religion}}</p>
